...
function add_expedited_order_woocommerce_email( $email_classes ){
    ...
    require plugin_dir_path( __FILE__ ) . 'class-wc-email-sender-student-email.php';
    require plugin_dir_path( __FILE__ ) . 'class-wc-email-sender-user-email.php';
    require plugin_dir_path( __FILE__ ) . 'class-wc-email-sender-email.php';
    ...
    $email_classes['WC_Email_Sender_Student_Email'] = new WC_Email_Sender_Student_Email();
    $email_classes['WC_Email_Sender_User_Email'] = new WC_Email_Sender_User_Email();
    $email_classes['WC_Email_Sender_Email'] = new WC_Email_Sender_Email();
