...
?>
    <p><?php printf( esc_html__( 'documents have been received from the student %s.', 'edusystem' ),$student->name.' '.$student->last_name); ?></p>

    <p><?= __('The following documents are required to be reviewed','edusystem').':'; ?></p>
