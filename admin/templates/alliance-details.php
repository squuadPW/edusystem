<div class="wrap">
    ...
    <div style="diplay:flex;width:100%;">
        <a class="button button-outline-primary" href="<?= admin_url('admin.php?page=add_admin_partners_content&section_tab=all_alliances'); ?>"><?= __('Back','aes'); ?></a>
    </div>
    <?php if(isset($alliance) && !empty($alliance)): ?>
        <?php if($alliance->status == 1): ?>
        <div style="display:flex;width:100%;justify-content:end;">
            <button data-id="<?= $_GET['alliance_id']; ?>" id="button-delete-alliance" class="button button-danger"><span class="dashicons dashicons-trash"></span><?= __('Delete','aes'); ?></button>
        </div>
        <?php endif; ?>
    <?php endif; ?>
                ...
                <div id="metabox" class="postbox" style="width:100%;min-width:0px;">
                    <div class="inside">
                        <form method="post" action="<?= __('admin.php?page=add_admin_partners_content&action=save_setting_alliance'); ?>">
                            <h3 style="margin-top:20px;margin-bottom:0px;text-align:center;"><b><?= __('General Information','aes'); ?></b></h3>
                            <table class="form-table table-customize" style="margin-top:0px;">
                                <tbody>
                                    <tr>
                                        <?php if(isset($alliance) && !empty($alliance)): ?>
                                            <th scope="row" style="font-weight:400;">
                                                <label for="input_id"><b><?= __('Franchise code','aes'); ?></b><?= ($alliance->status == 1) ? '<span class="required">*</span>' : ''; ?></label><br>
                                        ...
                                        <?php else: ?>
                                            <th scope="row" style="font-weight:400;">
                                                <label for="input_id"><b><?= __('Franchise code','aes'); ?></b><span class="required">*</span></label><br>
                                        ...
                                        <?php if(isset($alliance) && !empty($alliance)): ?>
                                            <?php if($alliance->status == 1): ?>
                                                <td>
                                                    <label for="input_id"><b><?= __('Franchise Type','aes'); ?></b><?= ($alliance->status == 1) ? '<span class="required">*</span>' : ''; ?></label><br>
                                                    <select style="width:100%" name="type" id="type" value="" required>
                                                        <option value=""></option>
                                                        <option value="1" <?= ($alliance->type == '1') ? 'selected' : ''; ?>><?= __('Junior','aes'); ?></option>
                                                        <option value="2" <?= ($alliance->type == '2') ? 'selected' : ''; ?>><?= __('Senior','aes'); ?></option>
                                                    </select>
                                                </td>
                                            <?php else: ?>
                                                <td>
                                                    <label for="input_id"><b><?= __('Franchise Type','aes'); ?></b></label><br>
                                                    <input type="text" name="type" id="type" style="width:100%" value="<?= (!empty($alliance->type)) ? get_name_type($alliance->type) : __('Type not assigned','aes'); ?>" readonly>
                                                </td>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <td>
                                                <label for="input_id"><b><?= __('Franchise Type','aes'); ?></b><span class="required">*</span></label><br>
                                                <select style="width:100%" name="type" id="type"required>
                                                    <option value=""></option>
                                                    <option value="1"><?= __('Junior','aes'); ?></option>
                                                    <option value="2"><?= __('Senior','aes'); ?></option>
                                                </select>
                                            </td>
                                        <?php endif; ?>
                                    </tr>
                                    <tr>
                                        ...
                                        <th scope="row" style="font-weight:400;">
                                            <?php if(isset($alliance) && !empty($alliance)): ?>
                                                    <label for="input_id"><b><?= __('Name','aes'); ?></b><?= ($alliance->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                        ...
                                        <td>
                                            <?php if(isset($alliance) && !empty($alliance)): ?>
                                                <label for="input_id"><b><?= __('Last name','aes'); ?></b><?= ($alliance->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                                <input type="text" name="last_name" style="width:100%" value="<?= ucwords($alliance->last_name); ?>" <?= ($alliance->status == 1) ? 'required' : 'readonly'; ?>>
                                            <?php else: ?>
                                                <label for="input_id"><b><?= __('Last name','aes'); ?></b><span class="text-danger">*</span></label><br>
                                                <input type="text" name="last_name" style="width:100%" value="" required>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if(isset($alliance) && !empty($alliance)): ?>
                                                <label for="input_id"><b><?= __('Legal name','aes'); ?></b><?= ($alliance->status == 1) ? '<span class="text-danger">*</span>' : '';  ?></label><br>
                                                <input type="text" name="legal_name" style="width:100%" value="<?= ucwords($alliance->name_legal); ?>" <?= ($alliance->status ==1 ) ? 'required' : 'readonly'; ?>>
                                            <?php else: ?>
                                                <label for="input_id"><b><?= __('Legal name','aes'); ?></b><span class="text-danger">*</span></label><br>
                                    ...
                                    <tr>
                                        <th scope="row" style="font-weight:400;">
                                            <?php if(isset($alliance) && !empty($alliance)): ?>
                                                <label for="input_id"><b><?= __('Phone','aes'); ?></b><?= ($alliance->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                        ...
                                        <td>
                                            <?php if(isset($alliance) && !empty($alliance)): ?>
                                                <label for="input_id"><b><?= __('Email','aes'); ?></b><?= ($alliance->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                    ...
                                    <tr>
                                        <th scope="row" style="font-weight:400;">
                                            <?php if(isset($alliance) && !empty($alliance)): ?>
                                                <label for="input_id"><b><?= __('State','aes'); ?></b><?= ($alliance->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                        ...
                                        <td>
                                            <?php if(isset($alliance) && !empty($alliance)): ?>
                                                <label for="input_id"><b><?= __('City','aes'); ?></b><?= ($alliance->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                        ...
                                        <td>
                                            <?php if(isset($alliance) && !empty($alliance)): ?>
                                                <label for="input_id"><b><?= __('Fee(%)','aes'); ?></b><?= ($alliance->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                                <input type="text" name="fee" id="fee" style="width:100%"  value="<?= $alliance->fee; ?>"<?= ($alliance->status == 1) ? 'required' : 'readonly'; ?>>
                                            <?php else: ?>
                                                <label for="input_id"><b><?= __('Fee(%)','aes'); ?></b><span class="text-danger">*</span></label><br>
                                    ...
                                    <tr>
                                        <?php if(isset($alliance) && !empty($alliance)): ?>
                                            <th colspan="3">
                                                <label for="input_id"><b><?= __('Address','aes'); ?></b><?= ($alliance->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                            ...
                            <?php if(isset($alliance) && !empty($alliance)): ?>
                                ...
                                <?php if($alliance->status == 1){ ?>
                                    <div style="margin-top:20px;display:flex;flex-direction:row;justify-content:end;gap:5px;">
                                        <button type="submit" class="button button-primary"><?= __('Save Changes','aes'); ?></button>
                                    </div>
                                <?php } ?>
                            <?php else: ?>
                                <div style="margin-top:20px;display:flex;flex-direction:row;justify-content:end;gap:5px;">
                                    <button type="submit" class="button button-primary"><?= __('Add Alliance','aes'); ?></button>
                                </div>
                            <?php endif; ?>
                        </form>
                    </div>
    ...
    <?php if(isset($alliance) && !empty($alliance)): ?>
        <?php if($alliance->status == 1): ?>
            <h2 style="margin-bottom:15px;"><?= __('Registered institutes','aes'); ?></h2>
                    ...
                    <div id="normal-sortables">
                        <div id="metabox" class="postbox" style="width:100%;min-width:0px;">
                            ...
                            <table id="table-products" class="wp-list-table widefat fixed posts striped" style="margin-top:20px;">
                                <thead>
                                    <tr>
                                        <th scope="col" class="manage-column column-primary column-title"><?= __('Institute name','aes') ?></th>
                                        <th scope="col" class="manage-column column-title-status"><?= __('Status','aes') ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if(isset($institutes) && !empty($institutes)): ?>
                                        <?php foreach($institutes as $institute): ?>
                                            <tr>
                                                <td class="column-primary" data-colname="<?= __('Institute name','aes'); ?>">
                                                    <?= $institute->name; ?>
                                                    <button type="button" class="toggle-row"><span class="screen-reader-text"></span></button>
                                                </td>
                                                <td class="column" data-colname="<?= __('Status','aes'); ?>"><?= get_name_status_institute($institute->status); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="2" style="text-align:center;"><?= __('There are no registered institutions','aes'); ?></td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
