                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row" style="font-weight:400;">
                                            <?php if (isset($alliance) && !empty($alliance)): ?>
                                                <label
                                                    for="input_id"><b><?= __('Manager\'s', 'edusystem'); ?></b><?= ($alliance->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                                <select name="managers[]" <?= ($alliance->status == 0) ? 'disabled' : 'required'; ?> style="width: 100%" multiple="multiple">
