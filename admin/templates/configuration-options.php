        ...
        <div class="card-body-configuration">
            ...
            >
                ...
                <div class="form-group" id="by_admission">
                    ...
                    <div class="form-group" style="padding: 0px 10px 10px 10px;">
                        <label for="documents-ok"><?= __('Days elapsed to display documents in green (less than)', 'edusystem' ); ?></label>
                        <br>
                        
                        <span><</span>
                        <input type="number" id="documents-ok" name="documents_ok" value="<?php echo get_option('documents_ok') ?>" required>
                    </div>

                    <div class="form-group" style="padding: 10px">

                        <label for="documents-warning">
                            <?= __('Days elapsed to display documents in warning (less than)', 'edusystem' ); ?>
                        </label>
                        ...
                        <input type="number" id="documents-warning" name="documents_warning" value="<?php echo get_option('documents_warning') ?>" required>
                    </div>

                    <div class="form-group" style="padding: 10px">
                        <label for="documents-red">
                            <?= __('Days elapsed to display documents in red (greater than)', 'edusystem'); ?>
                        </label>

                        <br>
                        <span>></span>

                        <input type="number" id="documents-red" name="documents_red" value="<?php echo get_option('documents_red') ?>" required>
                    </div>
                ...
                <div id="by_administration" style="display: none">
                    <div class="form-group" style="padding: 0px 10px 10px 10px;">
                        <label for="payment-due">
                            <?= __('Days elapsed after payment due to block access to the site (greater than)', 'edusystem'); ?>
                        </label>
                        ...
                        <input type="number" id="payment-due" name="payment_due" value="<?php echo get_option('payment_due') ?>" required>
                    </div>

                    <div class="form-group">
                        <a style="margin: 5px" href="<?= admin_url('admin.php?page=add_admin_form_academic_projection_content&action=set_max_access_date') ?>"
                            class="button button-outline-primary" onclick="return confirm('<?= __('Are you sure?', 'edusystem'); ?>');"
                        >
                    ...
                    <div class="form-group" style="padding: 0px 10px 10px 10px;">
                        ...
                        <label for="payment-due">
                            <?= __('Days allotted to upload proof of studies since first enrollment (greater than)', 'edusystem'); ?>
                        </label>
                        ...
                        <input type="number" id="proof-due" name="proof_due" value="<?php echo get_option('proof_due') ?>" required>
                    </div>

                    <div class="form-group">
                        <a style="margin: 5px" href="<?= admin_url('admin.php?page=add_admin_form_academic_projection_content&action=set_max_date_upload_at') ?>"
                            class="button button-outline-primary" onclick="return confirm('<?= __('Are you sure?', 'edusystem'); ?>');">
                    ...
                    <div class="form-group" style="padding: 0px 10px 10px 10px;">
                        <label for="default-lang-site"><?= __('Default site language'); ?></label>
                        <br>
                        <input type="text" id="default-lang-site" name="default_lang_site" value="<?php echo get_option('default_lang_site') ?>" required>
                    </div>

                    <div class="form-group" style="padding: 0px 10px 10px 10px;">

                        <label for="offer_complete"><?= __('Site mode', 'edusystem'); ?></label> 
                        <br>
                    ...
                    <div class="form-group" style="padding: 10px">
                        ...
                        <label for="multiple-accounts">
                            <?= __('Does the site have different fees for programs and other services?', 'edusystem'); ?>
                        </label>
                    </div>

                    <div class="form-group" style="padding: 10px">
                        <input type="checkbox" id="virtual-access" name="virtual_access" <?php echo get_option('virtual_access') == 'on' ? 'checked' : '' ?>>
                        <label for="virtual-access"><?= __('Show button for virtual classroom', 'edusystem'); ?></label>
                    </div>

                    <div class="form-group" style="padding: 10px">
                        <input type="checkbox" id="auto-enroll-regular" name="auto_enroll_regular" <?php echo get_option('auto_enroll_regular') == 'on' ? 'checked' : '' ?>>
                        <label for="auto-enroll-regular"><?= __('Auto enroll regular student', 'edusystem'); ?></label>
                    </div>
                    ...
                    <div class="form-group" style="padding: 10px">
                        ...
                        <label for="auto-enroll-elective"><?= __('Auto enroll elective student', 'edusystem'); ?></label>
                    </div>

                    <div class="form-group" style="padding: 10px">
                        <input type="checkbox" id="show-modal-elective" name="show_modal_electives" <?php echo get_option('show_modal_electives') == 'on' ? 'checked' : '' ?>>
                        <label for="show-modal-elective"><?= __('Show modal select elective', 'edusystem'); ?></label>
                    </div>
                    ...
                    <div class="form-group" style="padding: 10px">
                        ...
                        <label for="aditional-electives"><?= __('Use aditional electives', 'edusystem'); ?></label>
                    </div>
                    ...
                    <div class="form-group" style="padding: 10px">
                        ...
                        <label for="show-equivalence"><?= __('Show equivalency subjects in student projection', 'edusystem'); ?></label>
                    </div>
                    ...
                    <div class="form-group" style="padding: 10px">
                        ...
                        <label for="show-table-subjects-coursing"><?= __('Show table subjects coursing', 'edusystem'); ?></label>
                    </div>

                    <div class="form-group" style="padding: 10px">
                        <input type="checkbox" id="disabled-redirect" name="disabled_redirect" <?php echo get_option('disabled_redirect') == 'on' ? 'checked' : '' ?>>
                        <label for="disabled-redirect"><?= __('Disable redirection for institutes and alliances to the administrator', 'edusystem'); ?></label>
                    </div>
                    ...
                    <div class="form-group" style="padding: 10px">
                        ...
                        <label for="hide-contact-section-email"><?= __('Hide contact section email', 'edusystem'); ?></label>
                    </div>
                    ...
                    <div class="form-group" style="padding: 10px">
                        ...
                        <label for="auto-approve-institute"><?= __('Auto approve institute', 'edusystem'); ?></label>
                    </div>
            ...
            <div >
                ...
                <div id="by_offers" style="display: none">
                    ...
                    <div class="form-group" style="padding: 0px 10px 10px 10px;">
                        <label for="offer_quote">
                            <?= __('Coupon for registration fee with installment payments', 'edusystem'); ?>
                        </label>
                        <br>
                    ...
                    <div class="form-group" style="padding: 10px">
                        <label for="max-date-offer"><?= __('Max date', 'edusystem'); ?></label>
                ...
                <div id="by_notifications" style="display: none">
                    ...
                    <div class="form-group" style="padding: 0px 10px 10px 10px;">
                        <label for="email_coordination"><?= __('Email academic coordination', 'edusystem'); ?></label> 
                    ...
                    <div class="form-group" style="padding: 0px 10px 10px 10px;">
                        <label for="email_academic_management"><?= __('Email academic management', 'edusystem'); ?></label> 
                    ...
                    <div class="form-group" style="padding: 0px 10px 10px 10px;">
                        <label for="email_manager"><?= __('Email national and international manager', 'edusystem'); ?></label> <br>
                        <input class="full-input" type="email" id="email_manager" name="email_manager"
                            value="<?php echo get_option('email_manager') ?>">
                    </div>

                    <div class="form-group" style="padding: 0px 10px 10px 10px;">
                        <label for="email_administration"><?= __('Email administration', 'edusystem'); ?></label> <br>
                    ...
                    <div class="form-group" style="padding: 0px 10px 10px 10px;">
                        <label for="email_admission"><?= __('Email admission', 'edusystem'); ?></label> <br>
                ...
                <div id="by_design" style="display: none">
                    ...
                    <div class="logo-upload-section">
                        <div class="form-group">
                            <label for="logo_admin_login"><?= __('Administrator Login Logo', 'edusystem'); ?></label>
