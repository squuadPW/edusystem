                                ...
                                <tbody>
                                    <tr>
                                        <td style="font-weight:400; width: 33%;">
                                            <label for="input_id"><b><?= __('Name', 'edusystem'); ?></b><?= (isset($institute) && $institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                            <input type="text" name="name" value="<?= isset($institute) ? ucwords($institute->name) : ''; ?>" <?= (isset($institute) && $institute->status == 0) ? 'readonly' : 'required' ?>>
                                            <input type="hidden" name="institute_id" id="institute_id" value="<?= isset($institute) ? $institute->id : ''; ?>">
                                        </td>
                                        <td style="font-weight:400; width: 33%;">
                                            <label for="input_id"><b><?= __('Business name', 'edusystem'); ?></b><?= (isset($institute) && $institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                            <input type="text" name="business_name" value="<?= isset($institute) ? ucwords($institute->business_name) : ''; ?>" <?= (isset($institute) && $institute->status == 0) ? 'readonly' : 'required' ?>>
                                        </td>
                                        <td style="font-weight:400; width: 33%;">
                                            <label for="input_id"><b><?= __('Level', 'edusystem'); ?></b><?= (isset($institute) && $institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                    ...
                                    <tr>
                                        <td style="font-weight:400; width: 33%;">
                                            <label for="input_id"><b><?= __('Phone', 'edusystem'); ?></b><?= (isset($institute) && $institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                            <input type="text" id="phone" name="phone" value="<?= isset($institute) ? $institute->phone : ''; ?>" <?= (isset($institute) && $institute->status == 0) ? 'readonly' : 'required'; ?>>
                                            <input type="hidden" name="phone_hidden" id="phone_hidden" value="<?= isset($institute) ? $institute->phone : ''; ?>">
                                        </td>
                                        <td style="font-weight:400; width: 33%;">
                                            <label for="input_id"><b><?= __('Email', 'edusystem'); ?></b><?= (isset($institute) && $institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                            <input type="email" name="email" value="<?= isset($institute) ? $institute->email : ''; ?>" <?= (isset($institute) && $institute->status == 0) ? 'readonly' : 'required'; ?>>
                                        </td>
                                        <td style="font-weight:400; width: 33%;">
                                            <label for="input_id"><b><?= __('Type calendar', 'edusystem'); ?></b><?= (isset($institute) && $institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                            <?php if (isset($institute) && $institute->status == 0): ?>
                                                <input type="text" name="text" value="<?= get_type_calendar((int)$institute->type_calendar); ?>" readonly>
                                            <?php else: ?>
                                    ...
                                    <tr>
                                        <td style="font-weight:400; width: 33%;">
                                            <label for="input_id"><b><?= __('Country', 'edusystem'); ?></b><?= (isset($institute) && $institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                            <?php if (isset($institute) && $institute->status == 0): ?>
                                            ...
                                            <?php else: ?>
                                                <select name="country" required id="country-selector">
                                                    <?php foreach ($countries as $key => $country) { ?>
                                                        <option value="<?= $key; ?>" <?= (isset($institute) && $institute->country == $key) ? 'selected' : ''; ?>><?= $country ?></option>
                                                    <?php } ?>
                                                </select>
                                            <?php endif; ?>
                                        </td>
                                        <td style="font-weight:400; width: 33%;">
                                            <div id="state-td" <?= (!isset($institute) || $institute->status == 0) ? 'style="display: none"' : ''; ?>>
                                                <label for="input_id"><b><?= __('State', 'edusystem'); ?></b><?= (isset($institute) && $institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                                <?php if (isset($institute) && $institute->status == 0): ?>
                                                    <input type="text" name="country" value="<?= get_name_state($institute->country, $institute->state); ?>" readonly>
                                                <?php else: ?>
                                                    <select id="state-selector" name="state">
                                                        <?php foreach ($states as $key => $state) { ?>
                                                            <option value="<?= $key; ?>" <?= (isset($institute) && $key == $institute->state) ? 'selected' : ''; ?>><?= $state ?></option>
                                                        <?php } ?>
                                                    </select>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <td style="font-weight:400; width: 33%;">
                                            <label for="input_id"><b><?= __('City', 'edusystem'); ?></b><?= (isset($institute) && $institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                            <input type="text" name="city" value="<?= isset($institute) ? ucwords($institute->city) : ''; ?>" <?= (isset($institute) && $institute->status == 0) ? 'readonly' : 'required'; ?>>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="font-weight:400; width: 25%;">
                                            <label for="input_id"><b><?= __('Lower text', 'edusystem'); ?></b><?= (isset($institute) && $institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                            <input type="text" name="lower_text" value="<?= isset($institute) ? ucwords($institute->lower_text) : ''; ?>" <?= (isset($institute) && $institute->status == 0) ? 'readonly' : 'required' ?>>
                                        </td>
                                        <td style="font-weight:400; width: 25%;">
                                            <label for="input_id"><b><?= __('Middle text', 'edusystem'); ?></b><?= (isset($institute) && $institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                            <input type="text" name="middle_text" value="<?= isset($institute) ? ucwords($institute->middle_text) : ''; ?>" <?= (isset($institute) && $institute->status == 0) ? 'readonly' : 'required' ?>>
                                        </td>
                                        <td style="font-weight:400; width: 25%;">
                                            <label for="input_id"><b><?= __('Upper text', 'edusystem'); ?></b><?= (isset($institute) && $institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                            <input type="text" name="upper_text" value="<?= isset($institute) ? ucwords($institute->upper_text) : ''; ?>" <?= (isset($institute) && $institute->status == 0) ? 'readonly' : 'required' ?>>
                                        </td>
                                        <td style="font-weight:400; width: 25%;">
                                            <label for="input_id"><b><?= __('Graduated text', 'edusystem'); ?></b><?= (isset($institute) && $institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                            <input type="text" name="graduated_text" value="<?= isset($institute) ? ucwords($institute->graduated_text) : ''; ?>" <?= (isset($institute) && $institute->status == 0) ? 'readonly' : 'required' ?>>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
