<div class="wrap">
    ...
    <div style="display:flex;width:100%;">
        <a class="button button-outline-primary" href="<?= admin_url('admin.php?page=list_admin_institutes_partner_registered_content'); ?>"><?= __('Back','edusystem'); ?></a>
    </div>
    <?php if(isset($institute) && !empty($institute)): ?>
        <?php if($institute->status == 1): ?>
        <div style="display:flex;width:100%;justify-content:end;">
            <button data-id="<?= $_GET['institute_id']; ?>" id="button-delete-institute-alliance" class="button button-danger"><span class="dashicons dashicons-trash"></span><?= __('Delete','edusystem'); ?></button>
        </div>
        <?php endif; ?>
    <?php endif; ?>
