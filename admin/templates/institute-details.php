<div class="wrap">
    ...
    <div style="display:flex;width:100%;">
        <a class="button button-outline-primary" href="<?= admin_url('admin.php?page=add_admin_institutes_content&section_tab=all_institutes'); ?>"><?= __('Back','edusystem'); ?></a>
    </div>
    <?php if(isset($institute) && !empty($institute)): ?>
        <?php if($institute->status == 1): ?>
        <div style="display:flex;width:100%;justify-content:end;">
            <button data-id="<?= $_GET['institute_id']; ?>" id="button-delete-institute" class="button button-danger"><span class="dashicons dashicons-trash"></span><?= __('Delete','edusystem'); ?></button>
        </div>
        <?php endif; ?>
    <?php endif; ?>
                ...
                <div id="metabox" class="postbox" style="width:100%;min-width:0px;">
                    <div class="inside">
                        ...
                        <form method="post" action="<?= admin_url('admin.php?page=add_admin_institutes_content&action=save_institute_details'); ?>">
                            <h3 style="margin-top:20px;margin-bottom:0px;text-align:center;"><b><?= __('Institution Information','edusystem'); ?></b></h3>
                            ...
                            <table class="form-table">
                                ...
                                <tr>
                                    <td style="font-weight:400; width: 50%;">
                                        <?php if(isset($institute) && !empty($institute)): ?>
                                            <label for="input_id"><b><?= __('Name','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                    ...
                                    <td style="font-weight:400; width: 50%;">
                                        <?php if(isset($institute) && !empty($institute)): ?>
                                            <label for="input_id"><b><?= __('Business name','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                            <input type="text" name="business_name"  value="<?= ucwords($institute->business_name); ?>" <?= ($institute->status == 0) ? 'readonly' : 'required' ?>> 
                                            <input type="hidden" name="institute_id" id="institute_id" value="<?= $institute->id; ?>">
                                        <?php else: ?>
                                            <label for="input_id"><b><?= __('Business name','edusystem'); ?></b><span class="text-danger">*</span></label><br>
                                    ...
                                    <tr>
                                        <td>
                                            <?php if(isset($institute) && !empty($institute)): ?>
                                                <label for="input_id"><b><?= __('Phone','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                        ...
                                        <td> 
                                            <?php if(isset($institute) && !empty($institute)): ?>
                                                <label for="input_id"><b><?= __('Email','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                    ...
                                    <tr>
                                        <td>
                                            <?php if(isset($institute) && !empty($institute)): ?>
                                                <label for="input_id"><b><?= __('Country','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                        ...
                                        <td>
                                            <?php if(isset($institute) && !empty($institute)): ?>
                                                <div id="state-td">
                                                    <label for="input_id"><b><?= __('State','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                        ...
                                        <td>
                                            <?php if(isset($institute) && !empty($institute)): ?>
                                                <label for="input_id"><b><?= __('City','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row" style="font-weight:400;">
                                            <?php if(isset($institute) && !empty($institute)): ?>
                                                <label for="input_id"><b><?= __('Address','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                            ...
                            <table class="form-table" style="margin-top:0px;">
                                <tbody>
                                    <tr>
                                        <th scope="row" style="font-weight:400;">
                                            <?php if(isset($institute) && !empty($institute)): ?>
                                                <label for="input_id"><b><?= __('Description','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                    ...
                                    <tr>
                                        <th scope="row" style="font-weight:400;">
                                            <?php if(isset($institute) && !empty($institute)): ?>
                                                ...
                                                <label for="input_id"><b><?= __('Level','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                                <?php if($institute->status == 0): ?>
                                            ...
                                            <?php else: ?>
                                                <label for="input_id"><b><?= __('Level','edusystem'); ?></b><span class="text-danger">*</span></label><br>
                                                <select name="level" required >
                                        ...
                                        <?php if(isset($institute) && !empty($institute)): ?>
                                            <?php if($institute->status == 1): ?>
                                                <td>
                                                    <label style="font-weight:400;"><?= __('Fee','edusystem').' (%)'; ?><span class="text-danger">*</span></label><br>
                            ...
                            <h3 style="margin-top:20px;margin-bottom:0px;text-align:center;"><b><?= __('Rector Information','edusystem'); ?></b></h3>
                            <table class="form-table table-customize" style="margin-top:0px;">
                                <tbody>
                                    <tr>
                                        <th scope="row" style="font-weight:400;">
                                            <?php if(isset($institute) && !empty($institute)): ?>
                                                <label for="input_id"><b><?= __('Rector Name','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                                <input type="text" name="rector_name"  value="<?= ucwords($institute->name_rector); ?>" <?= ($institute->status == 0) ? 'readonly' : 'required'; ?>>
                                            <?php else: ?>
                                                <label for="input_id"><b><?= __('Rector Name','edusystem'); ?></b><span class="text-danger">*</span></label><br>
                                                <input type="text" name="rector_name"  value="" required>
                                            <?php endif; ?>
                                        </th>
                                        <td>
                                            <?php if(isset($institute) && !empty($institute)): ?>
                                                <label for="input_id"><b><?= __('Rector Lastname','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                                <input type="text" name="rector_last_name"  value="<?= ucwords($institute->lastname_rector); ?>" <?= ($institute->status == 0) ? 'readonly' : 'required'; ?>>
                                            <?php else: ?>
                                                <label for="input_id"><b><?= __('Rector Lastname','edusystem'); ?></b><span class="text-danger">*</span></label><br>
                            ...
                            <h3 style="margin-top:20px;margin-bottom:0px;text-align:center;"><b><?= __('Contact Information','edusystem'); ?></b></h3>
                            <table class="form-table table-customize" style="margin-top:0px;">
                                <tbody>
                                    <tr>
                                        <th scope="row" style="font-weight:400;">
                                            <?php if(isset($institute) && !empty($institute)): ?>
                                                <label for="input_id"><b><?= __('Contact Name','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                                <input type="text" name="contact_name"  value="<?= ucwords($institute->name_contact); ?>" <?= ($institute->status == 0) ? 'readonly' : 'required'; ?>>
                                            <?php else: ?>
                                                <label for="input_id"><b><?= __('Contact Name','edusystem'); ?></b><span class="text-danger">*</span></label><br>
                                                <input type="text" name="contact_name"  value="" required>
                                            <?php endif; ?>
                                        </th>
                                        <td>
                                            <?php if(isset($institute) && !empty($institute)): ?>
                                                <label for="input_id"><b><?= __('Contact Lastname','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                                <input type="text" name="contact_last_name"  value="<?= ucwords($institute->lastname_contact); ?>" <?= ($institute->status == 0) ? 'readonly' : 'required'; ?>>
                                            <?php else: ?>
                                                <label for="input_id"><b><?= __('Contact Lastname','edusystem'); ?></b><span class="text-danger">*</span></label><br>
                            ...
                            <h3 style="margin-top:20px;margin-bottom:0px;text-align:center;"><b><?= __('Alliances Information','edusystem'); ?></b></h3>
                            <table class="form-table table-customize" style="margin-top:0px;">
                                <tbody>
                                    <tr>
                                        <th scope="row" style="font-weight:400;">
                                            <?php if(isset($institute) && !empty($institute)): ?>
                                                <label for="input_id"><b><?= __('Alliance','edusystem'); ?></b><?= ($institute->status == 1) ? '<span class="text-danger">*</span>' : ''; ?></label><br>
                                            ...
                                            <?php else: ?>
                                                <label for="input_id"><b><?= __('Alliance','edusystem'); ?></b><span class="text-danger">*</span></label><br>
                            ...
                            <?php if(isset($institute) && !empty($institute)): ?>
                                <?php if($institute->status == 0): ?>
                                    <h3 style="margin-bottom:0px;text-align:center;"><b><?= __('Reference','edusystem'); ?></b></h3>
                                    <table class="form-table" style="margin-top:0px;">
                                        <tbody>
                                            <tr>
                                                <th scope="row" style="font-weight:400;">
                                                    <label for="input_id"><b><?= __('Reference','edusystem'); ?></b></label><br>
                            ...
                            <?php else: ?>
                                ...
                                <table class="form-table" style="margin-top:0px;">
                                    <tbody>
                                        <tr>
                                            <th scope="row" style="font-weight:400;">
                                                <label for="input_id"><b><?= __('Reference','edusystem'); ?></b><span class="text-danger">*</span></label><br>
                            ...
                            <?php if(isset($institute) && !empty($institute)): ?>
                                <?php if($institute->status == 0): ?>
                                    <div style="margin-top:20px;display:flex;flex-direction:row;justify-content:end;gap:5px;">
                                        <button type="button" data-id="1" data-title="<?= __('Approve Institution','edusystem'); ?>" data-message="<?= __('Do you want to approve this institution?','edusystem'); ?>" class="button button-primary change-status-institute"><?= __('Approve','edusystem'); ?></button>
                                        <button type="button" data-id="2" data-title="<?= __('Decline Institution','edusystem'); ?>" data-message="<?= __('Do pou you want to decline this institution?','edusystem'); ?>" class="button button-danger change-status-institute"><?= __('Declined','edusystem'); ?></button>
                                    </div>
                                <?php elseif($institute->status == 1): ?>
                                    <div style="margin-top:20px;display:flex;flex-direction:row;justify-content:end;gap:5px;">
                            ...
                            <?php else: ?>
                                    <div style="margin-top:20px;display:flex;flex-direction:row;justify-content:end;gap:5px;">
                                        <button type="submit" class="button button-primary"><?= __('Add Institute','edusystem'); ?></button>
                                    </div>
                            <?php endif; ?>
                        </form>
                    </div>
