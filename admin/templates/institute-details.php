<div class="wrap">
    ...
    <div style="display:flex;width:100%;">
        <a class="button button-outline-primary" href="<?= admin_url('admin.php?page=add_admin_institutes_content&section_tab=all_institutes'); ?>"><?= __('Back','aes'); ?></a>
    </div>
    <?php if(isset($institute) && !empty($institute)): ?>
        <?php if($institute->status == 1): ?>
        <div style="display:flex;width:100%;justify-content:end;">
            <button data-id="<?= $_GET['institute_id']; ?>" id="button-delete-institute" class="button button-danger"><span class="dashicons dashicons-trash"></span><?= __('Delete','aes'); ?></button>
        </div>
        <?php endif; ?>
    <?php endif; ?>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <?php if(isset($institute) && !empty($institute)): ?>
                                            <?php if($institute->status == 1): ?>
                                                <td>
                                                    <label style="font-weight:400;"><?= __('Fee','aes').' (%)'; ?><span class="text-danger">*</span></label><br>
