<div class="tabs-content">
	<div class="wrap">
		...
		<div style="display:flex;width:100%;justify-content:end;margin-bottom:10px;">
				<a href="<?= admin_url('admin.php?page=add_admin_form_academic_projection_content&section_tab=add_subject'); ?>" class="button button-outline-primary"><?= __('Add Subject','aes'); ?></a>
			</div>
