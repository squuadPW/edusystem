...
<div class="tabs-content">
	<div class="wrap">
        <div style="text-align:start;">
			<h1 class="wp-heading-line"><?= __('Available scholarships','aes'); ?></h1>
		</div>
		<div style="display:flex;width:100%;justify-content:end;margin-bottom:10px;">
			<a href="<?= admin_url('admin.php?page=add_admin_form_available_scholarships_content&section_tab=available_scholarship_detail'); ?>"><button class="button button-outline-primary"><?= __('Add scholarship','aes'); ?></button></a>
		</div>
