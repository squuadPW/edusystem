<h2 class="nav-tab-wrapper">
	<a href="<?= admin_url('admin.php?page=add_admin_form_pensum_content') ?>"
		class="nav-tab <?= (!isset($_GET['section_tab'])) ? 'nav-tab-active' : ''; ?>"><?= __('Program pensum', 'edusystem'); ?></a>
	<a href="<?= admin_url('admin.php?page=add_admin_form_pensum_content&section_tab=pensum_institute'); ?>"
		class="nav-tab <?= (isset($_GET['section_tab']) && !empty($_GET['section_tab']) && $_GET['section_tab'] == 'pensum_institute') ? 'nav-tab-active' : ''; ?>"><?= __('Institute\'s pensum', 'edusystem'); ?></a>
</h2>
