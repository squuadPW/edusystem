<h2 class="nav-tab-wrapper">
	...
	<a href="<?= admin_url('admin.php?page=add_admin_form_requests_content&section_tab=types'); ?>" class="nav-tab <?= (isset($_GET['section_tab']) && !empty($_GET['section_tab']) && $_GET['section_tab'] == 'types') ? 'nav-tab-active' : ''; ?>"><?= __('Types','form-plugin'); ?></a>
</h2>
	...
	<div class="wrap">
        <div style="text-align:start;">
			...
			<?php elseif(isset($_GET['section_tab']) && !empty($_GET['section_tab']) && $_GET['section_tab'] == 'types'): ?>
				<h1 class="wp-heading-line"><?= __('Types','aes'); ?></h1>
			<?php endif; ?>
		</div>
		<?php if(isset($_GET['section_tab']) && !empty($_GET['section_tab']) && $_GET['section_tab'] == 'types'): ?>
			<div style="display:flex;width:100%;justify-content:end;margin-bottom:10px;">
				<a href="<?= admin_url('admin.php?page=add_admin_form_requests_content&section_tab=type_details'); ?>" class="button button-outline-primary"><?= __('Add Type','aes'); ?></a>
			</div>
		<?php endif; ?>
