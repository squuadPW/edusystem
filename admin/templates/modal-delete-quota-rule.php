<div id='modalDeleteQuotaRule' class='modal' style='display:none'>
	<div class='modal-content'>
		...
		<form method="post"
			action="<?= admin_url('/admin.php?page=add_admin_form_program_content&action=delete_quota_rule'); ?>">
			<div class="modal-body" style="margin: 10px; padding: 0px">
				<div class="display:flex">
					<p><?= __('Do you want to delete this rule for the quota?', 'edusystem'); ?></p>
					<input type="hidden" id="delete_quota_rule_button" name="quota_rule_id" value="">
				</div>
			</div>
