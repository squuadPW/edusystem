<div class="wrap">
	<h1 class="wp-heading-line"><?= __('Moodle Settings','edusystem'); ?></h1>
	<form method="post" action="<?= admin_url('admin.php?page=moodle-setting&action=save_setting') ?>"> 
		<table class="form-table">
			<tbody>
				<tr>
					<th scope="row"><label for="input_id"><?= __('Moodle URL','edusystem'); ?></label></th>
					<td><input name="moodle_url" type="text" id="moodle_url" value="<?= get_option('moodle_url'); ?>" class="regular-text"></td>
				</tr>
				<tr>
					<th scope="row"><label for="input_id"><?= __('Moodle Token','edusystem'); ?></label></th>
