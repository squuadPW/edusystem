            ...
            <tbody>
                ...
                <div>
                    <tr>
                        ...
                        <td style="display:table-cell;padding:3px;"><label for="manager_academic_aes"><?= __('Academic','aes'); ?></label></td>
                    </tr>
                    <tr>
                        <th scope="row" style="width:10px;padding:3px;">
                        ...
                        <td style="display:table-cell;padding:3px;"><label for="manager_academic_projection_aes" style="margin-left:20px;"><?= __('Academic projection','aes'); ?></label></td>
                    </tr>
                    <tr>
                        <th scope="row" style="width:10px;padding:3px;">
                ...
                <div>
                    <tr>
                        ...
                        <td style="display:table-cell;padding:3px;"><label for="manager_staff_menu_aes"><?= __('Staff','aes'); ?></label></td>
                    </tr>
                    <tr>
                        <th scope="row" style="width:10px;padding:3px;">
                        ...
                        <td style="display:table-cell;padding:3px;"><label for="manager_staff_aes" style="margin-left:20px;"><?= __('Manage staff','aes'); ?></label></td>
                    </tr>
                    <tr>
                        <th scope="row" style="width:10px;padding:3px;">
                        ...
                        <td style="display:table-cell;padding:3px;"><label for="manager_institutes_aes" style="margin-left:20px;"><?= __('Institutes','aes'); ?></label></td>
                    </tr>
                    <tr>
                        <th scope="row" style="width:10px;padding:3px;">
                        ...
                        <td style="display:table-cell;padding:3px;"><label for="manager_alliances_aes" style="margin-left:20px;"><?= __('Alliances','aes'); ?></label></td>
                    </tr>
                </div>
                <!-- STAFF -->
                ...
                <div>
                    ...
                    <tr>
                        ...
                        <td style="display:table-cell;padding:3px;"><label for="manager_report_current_students_aes" style="margin-left:20px;"><?= __('Report current students enrolled','aes'); ?></label></td>
                    </tr>
                    <tr>
                        <th scope="row" style="width:10px;padding:3px;">
                ...
                <div>
                    <tr>
                        ...
                        <td style="display:table-cell;padding:3px;"><label for="manager_settings_aes"><?= __('Settings menu','aes'); ?></label></td>
                    </tr>
                    <tr>
                        <th scope="row" style="width:10px;padding:3px;">
                    ...
                    <tr>
                        ...
                        <td style="display:table-cell;padding:3px;"><label for="manager_configuration_options_aes" style="margin-left:20px;"><?= __('Configurations of the site','aes'); ?></label></td>
                    </tr>
                </div>
                <!-- CONFIGURATIONS -->
