        ...
        <div class="form-section">
            ...
            <div class="capability-group">
                ...
                <div class="capability-item indented">
                    ...
                    <label for="manager_dynamic_links" <?= !in_array('manager_dynamic_links', $departments_subscription) ? 'style="font-style: italic; color: #8080808a; pointer-events: none;"' : '' ?>><?= __('Payment link generator', 'edusystem'); ?></label>
                </div>
            </div>
