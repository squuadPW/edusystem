...
const formDocument = document.getElementById("send-documents-teacher");
...
progressButton.addEventListener("click", function () {
  ...
  xhr.open("POST", save_documents_teacher.url, true);
  xhr.send(formData);
});
...
function closeSelectorPhoto() {
  ...
  document.getElementById("teacher_photo_label_input").textContent = "Select file";
