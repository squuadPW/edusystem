        ...
        <div class="modal-body" id="content-pdf">
            <div id="part1" style="font-size: 12px; color: #000">
                ...
                <div>
                    ...
                    <div style="display: flex">
                        <div style="flex: auto; border: 1px solid gray; padding: 8px;"><strong>Identification # or Passport # of parent:</strong> 
                    ...
                    <div style="display: flex">
                        <div style="flex: auto; border: 1px solid gray; padding: 8px;"><strong>Parent/Legal Guardian Full Name:</strong> 
                ...
                <div>
                    ...
                    <div style="display: flex">
                        <div style="flex: auto; border: 1px solid gray; padding: 8px;">
                            <strong>Name of Last or Concurrent School:</strong> <?php echo isset($institute) ? $institute->name : $institute_name ?> <br><br>
                            <strong>School Address:</strong> <?php echo isset($institute) ? $institute->address : '' ?> <br><br>
                            ...
                            <strong>Last completed grade:</strong> <br> 
                                <span onclick="updateGrade('grade1')" style="cursor: pointer"><span id="grade1">( )</span> 5th Grade</span>
                                <span onclick="updateGrade('grade2')" style="cursor: pointer"><span id="grade2">( )</span> 6th Grade</span>
                                <span onclick="updateGrade('grade3')" style="cursor: pointer"><span id="grade3">( )</span> 7th Grade</span>
                                <span onclick="updateGrade('grade4')" style="cursor: pointer"><span id="grade4">( )</span> 8th Grade</span>
                                <span onclick="updateGrade('grade5')" style="cursor: pointer"><span id="grade5">( )</span> 9th Grade</span>
                                <span onclick="updateGrade('grade6')" style="cursor: pointer"><span id="grade6">( )</span> 10th Grade</span>
                                <span onclick="updateGrade('grade7')" style="cursor: pointer"><span id="grade7">( )</span> 11th Grade</span>
                                <span onclick="updateGrade('grade8')" style="cursor: pointer"><span id="grade8">( )</span> 12th Grade</span>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div style="display: flex">
                        <div style="flex: auto; border: 1px solid gray; padding: 8px;">
                            ...
                            [<?php echo $user['student_payment'] == '2' ? '✓' : '  ' ?>] Full Academic year payment at time of signing enrollment agreement. <br>
                            [<?php echo $user['student_payment'] == '1' ? '✓' : '  ' ?>] Balance paid prior to graduation through payment plan, according to an agreed upon
