            ...
            <div class="modal-body" id="content-pdf">
                <form method="POST" action="<?php the_permalink(); ?>?action=save_student_info" class="form-aes"
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
                            <label for="birth_date"><?= __('Date of birth', 'edusystem'); ?><span
                        ...
                        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
                            <label for="birth_date"><?= __('Type document', 'edusystem'); ?><span
                                    class="required">*</span></label>
                            <select name="document_type" autocomplete="off" oninput="sendAjaxIdDocument()" required>
                                ...
                                <option value="identification_document"><?= __('Identification Document', 'edusystem'); ?>
                                </option>
                                <option value="ssn"><?= __('SSN', 'edusystem'); ?></option>
                            </select>
                        </div>
                        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
                            <label for="birth_date"><?= __('ID document', 'edusystem'); ?><span
                                    class="required">*</span></label>
                        ...
                        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
                            <label for="lastname"><?= __('Middle name', 'edusystem'); ?><span
                                    class="required">*</span></label>
                        ...
                        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
                            <label for="lastname"><?= __('Second surname', 'edusystem'); ?><span
                                    class="required">*</span></label>
                            <input class="formdata capitalize" type="text" name="middle_last_name_student"
                                autocomplete="off" required>
                        </div>
                        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
                            <label for="phone"><?= __('Contact number', 'edusystem'); ?><span
                                    class="required">*</span></label>
                        ...
                        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
                            <div id="student-email">
                                <label for="email"><?= __('Email address', 'edusystem'); ?><span
                                        class="required">*</span></label>
                        ...
                        <div id="parent_document_type_field"
                            ...
                            <select name="parent_document_type" autocomplete="off" id="parent_document_type" required>
                                <option value="" <?php echo !get_user_meta($current_user->ID, 'type_document', true) ? 'selected' : '' ?>><?= __('Select an option', 'edusystem'); ?></option>
                                <option value="passport" <?php echo get_user_meta($current_user->ID, 'type_document', true) == 'passport' ? 'selected' : '' ?>><?= __('Passport', 'edusystem'); ?></option>
                                <option value="identification_document" <?php echo get_user_meta($current_user->ID, 'type_document', true) == 'identification_document' ? 'selected' : '' ?>>
                                    <?= __('Identification Document', 'edusystem'); ?>
                                </option>
                                <option value="ssn" <?php echo get_user_meta($current_user->ID, 'type_document', true) == 'ssn' ? 'selected' : '' ?>><?= __('SSN', 'edusystem'); ?></option>
                            </select>
                        </div>
                        <div>
                        </div>
                        ...
                        <div id="parent-lastname-field" class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
                            <label for="agent_name"><?= __('First surname', 'edusystem'); ?><span
                                    class="required">*</span></label>
                        ...
                        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6" id="parent-gender-field">
                            <label for="gender_parent"><?= __('Gender', 'edusystem'); ?><span
                                    class="required">*</span></label>
                            <select class="form-control" id="gender_parent" required name="gender_parent"
                                ...
                                <option value="" selected="selected"><?= __('Select an option', 'edusystem'); ?></option>
                                <option value="male" <?php echo get_user_meta($current_user->ID, 'gender', true) == 'male' ? 'selected' : '' ?>><?= __('Male', 'edusystem'); ?></option>
                                <option value="female" <?php echo get_user_meta($current_user->ID, 'gender', true) == 'female' ? 'selected' : '' ?>><?= __('Female', 'edusystem'); ?></option>
                            </select>
                        </div>
                        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
                            <label for="country"><?= __('Country', 'edusystem'); ?><span
                                    class="required">*</span></label>
                        ...
                        <!-- <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6 mt-10"
                            style="margin-top: 30px !important; background: rgb(223 223 223); color: black">
                            <div class="subtitle text-align-center"><?= __('Platform access data', 'edusystem'); ?></div>
                        </div> -->
                        ...
                        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
                            <label
                                for="name_institute"><?= __('Name of School or Institution with Agreement', 'edusystem'); ?><span
                        ...
                        <div id="name-institute-field" class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6"
                            style="display:none;">
                            <label for="name_institute"><?= __('Name Institute', 'edusystem'); ?><span
                                    class="required">*</span></label>
