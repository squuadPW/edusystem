    ...
    <div id="modal-contraseña" class="modal" style="overflow: auto; padding: 0 !important">
        <div class="modal-content modal-enrollment">
            ...
            <div class="modal-body" id="content-pdf">
                <form method="POST"
                    action="<?php the_permalink(); ?>?action=save_student_custom&idbitrix=<?php echo $_GET['idbitrix'] ?? null ?>"
                    class="form-aes">
                    <input class="formdata" autocomplete="off" type="hidden" id="modal_open"
                                name="modal_open" value="1">
                    <div id="loading"
