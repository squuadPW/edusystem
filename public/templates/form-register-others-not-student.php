<form method="POST" action="<?= the_permalink() . '?action=new_applicant_others'; ?>" class="form-aes form-aes-others"
    id="form-others" style="display: none" autocomplete="off">
    <div class="grid grid-cols-12 gap-4">
        ...
        <div id="name-institute-field-others" class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6"
            style="display:none;">
            <label for="name_institute_others"><?= __('Name Institute', 'edusystem'); ?><span
        ...
        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6 mt-3" style="text-align:center;">
            <button class="submit" id="buttonsave_others"><?= __('Send', 'edusystem'); ?></button>
        </div>
    </div>
</form>