<div id="modal-continue-checkout" class="modal" style="display: none; z-index: 10000">
    ...
    <div class="modal-header p-5">
        <h3 style="font-weight: 600"><?= __('Previous form','edusystem') ?></h3>
        <!-- <span class="modal-close" id="close-continue"><span class="dashicons dashicons-no-alt"></span></span> -->
      </div>
      <div class="modal-body">
          <div>
            <p style="font-size: 12px; font-style: italic; text-align: center"><?= __('We have found that you have done a previous form, do you want to continue with the same information or do you want to start again?','edusystem') ?></p>
          </div>
