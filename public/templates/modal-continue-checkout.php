    ...
    <div class="modal-header p-5">
      ...
      <div class="modal-body">
          ...
          <div style="text-align:center; margin-top: 3rem">
            ...
            <button style="margin-top: 20px; background-color: #ffffff !important; border: 1px solid #2e6da4; color: #002fbd !important;" type="button" class="submit button-primary" id="quit-checkout"><?= __('Start a new one', 'aes'); ?></button>
          </div>
      </div>
    </div>
  </div>