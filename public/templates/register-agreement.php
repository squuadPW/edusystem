...
<form method="POST" action="<?= the_permalink().'?action=save_institute'; ?>">
    <div class="grid grid-cols-12 gap-4">
        ...
        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
            ...
            <input class="formdata number_phone" type="tel" name="phone" required>
        </div>
        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
        ...
        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
            ...
            <input class="formdata number_phone" type="tel" name="rector_phone" required>
        </div>
