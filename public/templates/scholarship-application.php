<div class="title">
    <?= __('Scholarship application', 'edusystem'); ?>
</div>
    ...
    <div class="grid grid-cols-12 gap-4">
        ...
        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
            ...
            <span id="scholarship_assigned"
                style="font-style: italic; color: gray; font-size: 12px; display: none"></span>
        </div>
        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
        ...
        <div id="parent-lastname-field" class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6">
            <label for="agent_name"><?= __('First surname', 'edusystem'); ?><span class="required">*</span></label>
        ...
        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6 mt-10"
            style="margin-top: 30px !important; background: rgb(223 223 223); color: black">
            <div class="subtitle text-align-center" id="access_data"><?= __('Platform access data of parent', 'edusystem'); ?></div>
        </div>
