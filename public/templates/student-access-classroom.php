...
<div class="content-dashboard">
    ...
    <div style="display:flex">
        <div style="width: 100%; text-align: center">
            <a style="width: 60% !important; <?php echo count($access) == 0 ? 'background-color: #091c5c75 !important; pointer-events: none;' : '' ?>" target="_blank" href="<?= home_url('?action=access_moodle_url&student_id='.$data->id); ?>" class="button button-primary"><?= __('Virtual Classroom','aes'); ?></a>
        </div>
