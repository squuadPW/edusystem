...
<div style="margin-top:20px;">
    <a href="<?= wc_get_account_endpoint_url('student') ?>" class="button button-primary" style="width:auto"><?= __('Back','edusystem'); ?></a>
</div>
...
<form action="" method="post" style="margin-top:20px;" >
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		...
		<?php if($student->status_id < 2): ?>
			<select style="height:43.75px;padding:5px !important; background-color: #e0e7ff !important" name="document_type" disabled>
				<option value=""></option>
				<option value="identification_document" <?= ($student->type_document == 'identification_document') ? 'selected' : ''; ?>><?= __('Identification Document','edusystem'); ?></option>
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-last">
		<label for="id_document"><?php esc_html_e( 'ID document', 'edusystem' ); ?></label>
		<?php if($student->status_id < 2): ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		<label for="account_first_name"><?php esc_html_e( 'First name', 'edusystem' ); ?></label>
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-last">
		<label for="account_first_name"><?php esc_html_e( 'Middle Name', 'edusystem' ); ?>&nbsp;<span>(<?= __('Optional','edusystem'); ?>)</span></label>
		<?php if($student->status_id < 2): ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-first">
		<label for="account_last_name"><?php esc_html_e( 'Last name', 'edusystem' ); ?></label>
		<?php if($student->status_id < 2): ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
		<label for="account_last_name"><?php esc_html_e( 'Middle Last name', 'edusystem' ); ?>&nbsp;<span>(<?= __('Optional','edusystem'); ?>)</span></label>
		<?php if($student->status_id < 2): ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-first">
		<label for="birth_date"><?php esc_html_e( 'Birth Date', 'edusystem' ); ?></label>
		<?php if($student->status_id < 2): ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
		<label for="account_last_name"><?php esc_html_e( 'Gender', 'edusystem' ); ?></label>
		<?php if($student->status_id < 2): ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-last">
		<label for="number_phone"><?php esc_html_e( 'Phone', 'edusystem' ); ?></label>
		<?php if($student->status_id < 2): ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-first">
		<label for="account_email"><?php esc_html_e('Country', 'edusystem' ); ?></label>
		<?php if($student->status_id < 2): ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-last">
		<label for="account_email"><?php esc_html_e('City', 'edusystem' ); ?></label>
		<?php if($student->status_id < 2): ?>			
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-first">
		<label for="billing_postcode"><?php esc_html_e('Postal Code', 'edusystem' ); ?></label>
		<?php if($student->status_id < 2): ?>
	...
	<p>
		...
		<?php if($student->status_id < 2): ?>
			<!-- <button style="margin-top:20px;" type="submit" class="button-primary" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'edusystem' ); ?></button>
			<input type="hidden" name="action" value="save_student_details" /> -->
		<?php else: ?>
			<!-- <button style="margin-top:20px;" type="submit" class="button-primary" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>" disabled><?php esc_html_e( 'Save changes', 'edusystem' ); ?></button> -->
		<?php endif; ?>
	</p>
	<!--
	<?php if($student->status_id == 2 && !empty($student->moodle_student_id)): ?>
		<p>
			<h2 style="margin-top:1rem;"><?= __('Virtual Classroom Information','edusystem'); ?></h2>
		</p>

		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-first">
			<label for="billing_postcode"><?php esc_html_e('Username', 'edusystem' ); ?></label>
		...
		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-last">
			<label for="billing_postcode"><?php esc_html_e('Password', 'edusystem' ); ?></label>
		...
		<p>
			<button style="width:100%;margin-top:20px;" type="submit" class="woocommerce-Button button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'edusystem' ); ?></button>
