...
<form action="" method="post" style="margin-top:20px;" >
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		<label for="document_type"><?php esc_html_e( 'Document Type', 'aes' ); ?>&nbsp;<span class="required">*</span></label>
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-last">
		<label for="id_document"><?php esc_html_e( 'ID document', 'aes' ); ?>&nbsp;<span class="required">*</span></label>
		<?php if($student->status_id < 2): ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		<label for="account_first_name"><?php esc_html_e( 'First name', 'aes' ); ?>&nbsp;<span class="required">*</span></label>
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-last">
		...
		<?php if($student->status_id < 2): ?>
			<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_middle_name" id="account_middle_name" autocomplete="given-name" value="<?php echo esc_attr( $student->middle_name ); ?>"/>
		<?php else: ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-first">
		<label for="account_last_name"><?php esc_html_e( 'Last name', 'aes' ); ?>&nbsp;<span class="required">*</span></label>
		<?php if($student->status_id < 2): ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
		...
		<?php if($student->status_id < 2): ?>
			<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_middle_last_name" id="account_middle_last_name" autocomplete="family-name" value="<?php echo esc_attr( $student->middle_last_name ); ?>"/>
		<?php else: ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-first">
		<label for="birth_date"><?php esc_html_e( 'Birth Date', 'aes' ); ?>&nbsp;<span class="required">*</span></label>
		<?php if($student->status_id < 2): ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
		<label for="account_last_name"><?php esc_html_e( 'Gender', 'aes' ); ?>&nbsp;<span class="required">*</span></label>
		<?php if($student->status_id < 2): ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-last">
		<label for="number_phone"><?php esc_html_e( 'Phone', 'aes' ); ?>&nbsp;<span class="required">*</span></label>
		<?php if($student->status_id < 2): ?>
			<input type="text" class="woocommerce-Input woocommerce-Input--email input-text" name="number_phone" id="number_phone_account"  value="<?= $student->phone; ?>" required />
			<input type="hidden" class="woocommerce-Input woocommerce-Input--email input-text" name="number_phone_hidden" id="number_phone_hidden"  value="<?= $student->phone; ?>" required />
		<?php else: ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-first">
		<label for="account_email"><?php esc_html_e('Country', 'aes' ); ?>&nbsp;<span class="required">*</span></label>
		<?php if($student->status_id < 2): ?>
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-last">
		<label for="account_email"><?php esc_html_e('City', 'aes' ); ?>&nbsp;<span class="required">*</span></label>
		<?php if($student->status_id < 2): ?>			
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-first">
		<label for="billing_postcode"><?php esc_html_e('Postal Code', 'aes' ); ?>&nbsp;<span class="required">*</span></label>
		<?php if($student->status_id < 2): ?>
	...
	<?php if($student->status_id == 2 && !empty($student->moodle_student_id)): ?>
		...
		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-last">
			...
			<input type="password" class="woocommerce-Input woocommerce-Input--text input-text" name="password" id="password"  value="<?= $student->moodle_password; ?>" required />
		</p>
		<p>
