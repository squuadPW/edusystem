<form method="POST"
    ...
    <div class="grid grid-cols-12 gap-4">
        ...
        <div class="col-start-1 sm:col-start-4 col-span-12 sm:col-span-6" id="program_select" style="display: <?= count($programs) > 1 ? 'block' : 'none' ?>;">
            ...
            <select name="program" id="program" autocomplete="off" required>
                <option value="" <?= count($programs) > 1 ? 'selected' : '' ?>><?= __('Select an option', 'edusystem'); ?></option>
