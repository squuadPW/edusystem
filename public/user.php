...
function create_and_login_user_if_payment_successful($order_id, $old_status, $new_status, $order) {
    ...
    if( !isset( $registration_data['parent']['user_id'] ) ) {
        ...
        $password = base64_decode( $registration_data['access']['password'] ) ?? wp_generate_password(); // Strong password generated by WordPress
        ...
        // insercion de data del padre cliente
        $meta_data_map = [
    ...
    // verifica si los datos requeridos del estudiente estan completos
    $required_student_data = [
        'name', 'last_name', 'birth_date', 'email', 'phone'
    ];
    ...
    // verifica si los datos requeridos del program estan completos
    $required_program_data = [ 'initial_grade', 'program_id' ];
    ...
    // creaciion de usuario estudiante
